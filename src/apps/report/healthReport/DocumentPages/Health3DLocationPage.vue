...
import BubbleChartDocumentLarge from "./com/Bubble3DChartDocumentLarge.vue";
  ...
  <div class="custom-page page a4">
    <div class="page-inside">
      ...
      <div class="title-container">
        <div class="title">
          ...
          <span class="stretch-text">
            노화 억제 분석 지수, 만성질환 억제 분석 지수, 근육 밸런스 분석 지수를 기반으로 3차원 그래프에 표현한 나의 건강 위치를 확인해보세요.
          </span>
        </div>
      </div>
      <div class="data-container">
        ...
        <div class="data">
          <!-- 나의 건강 위치 그래프 -->
          <BubbleChartDocumentLarge :save="props.save" :pdfScale="props.pdfScale"
            :health-score-data="props.healthScoreData" />
        </div>
      </div>
      <div class="desc">
        {{ props.userInfo.user_name }}님의 건강상태는 파란색 아이콘으로 표현되어 있습니다.<br />
        노화 억제 분석 지수는 {{ props.healthScoreData.hq_oxi.score }}점, 
        만성질환 억제 분석 지수는 {{ props.healthScoreData.hq_met.score }}점, 
        근육 밸런스 분석 지수는 {{ props.healthScoreData.hq_musBal.score }}점을 종합하면 건강 위치가
      ...
      <div class="bottom-info">
        *본 서비스는 질병의 예방 또는 진단을 목적으로 제공되는 서비스가 아닙니다.
        ...
        노화 억제 분석 지수와 만성질환 억제 분석 지수, 근육 밸런스 분석 지수는 건강검진 결과, 생활 습관 등 다양한 요소 간의 상관관계를 종합적으로 고려하여 산출됩니다.
