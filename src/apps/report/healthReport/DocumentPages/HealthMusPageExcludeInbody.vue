  ...
  <div class="custom-page page a4">
    <div class="page-inside">
      ...
      <div class="title-container">
        ...
        <div class="score-container">
          ...
          <div class="score-chart">
            <div class="score-div">
              <!-- 점수 그래프 -->
              <ScoreComDocument :pdfScale="props.pdfScale" :value="0" :status="props.healthScoreData.hq_musBal.status"
                :width="8" :hideScore="true" :right="false" />
            </div>
            <div class="score">
      ...
      <div class="data-desc-container">
        <DimComponent :html-text="'체성분 데이터 입력 시 <br/> ‘근육 밸런스 분석 지수’ 를<br/> 확인 할 수 있습니다.'" :padding-flag="true" />
