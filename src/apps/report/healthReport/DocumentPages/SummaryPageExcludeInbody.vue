...
import Bubble2DChartDocument from "./com/Bubble2DChartDocument.vue";
    ...
    <div class="page-inside">
      ...
      <div class="summary">
        ...
        <div class="summary-desc">
          ...
          노화속도는 {{ props.healthScoreData.hq_ar.aging_rate }} 배속으로 
          {{ props.healthScoreData.hq_ar.status == 1 ? '저속 노화' :
          ...
          <div class="position">
            ...
            <div class="chart">
              <div class="bubble">
                ...
                <!-- 나의 건강 위치 그래프 -->
                <Bubble2DChartDocument :health-score-data="props.healthScoreData" :pdfScale="props.pdfScale"
          ...
          <div class="score">
            <div class="health">
              ...
              <div class="mus-container">
                <DimComponent :html-text="'체성분 데이터 입력 시 <br/>‘근육 밸런스 분석 지수’를<br/>확인할 수 있습니다.'" :padding-flag="false" />
