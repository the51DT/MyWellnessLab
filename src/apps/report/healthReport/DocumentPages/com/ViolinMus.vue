  ...
  <div class="chart-wrapper">
    <div class="data-container">
      ...
      <div class="violin-container">
        <div class="label-y">근육 밸런스 지수</div>
        <div class="violin">
          ...
          <div class="background-box">
            <div class="my-point-box">
              <div class="my-point" :style="{
                ...
                <div class="my-point-score">{{ mus.rank }}등</div>
              </div>
              ...
              <img class="background"
                :src="health_checkup_mus_image(ageToAgeGroup(props.healthScoreData.hqReference.age), props.userInfo.user_gender)" />
            </div>
