...
watch(
  () => [props.healthReportScoreData, props.healthReportRfsData, props.healthReportSleepHabitsData],
  (
    [newHealthReportScoreData, newHealthReportRfsData, newHealthReportSleepHabitsData],
    [oldHealthReportScoreData, oldHealthReportRfsData, oldHealthReportSleepHabitsData]
  ) => {
    if (newHealthReportScoreData != null && newHealthReportRfsData && newHealthReportSleepHabitsData) {
...
<template>
  ...
  <cardComponent :title=props.title :more="false" :activeCard="props.activeCardNumber == 1">
    <template v-slot:content>
      ...
      <div class="status-grid-container" v-if="datas != null">
        <div class="status-grid-box two">
