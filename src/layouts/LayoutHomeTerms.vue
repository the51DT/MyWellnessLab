...
const terms_api = import.meta.env.VITE_GLOB_BASE_API_URL + "/v1/api/user/terms/list/0";
...
const prefix = "LayoutHomeTerms";
const props = defineProps({
  isPopupTerms: Boolean
})
...
<template>
  <base-popup-tit v-if="props.isPopupTerms" @popupClose="popupClose" class="LayoutHomeTermsPopup">
    <template v-slot:title>
      {{ $t('CheckupPrivacyAgreePopup.text12')}}
    </template>
