...
const publishingRouter = {
  ...
  children: [
...

    {
      ...
      component:
        LayoutOrderNpay /* 주문 결제의 경우 mpn을 그대로 가져왔기 때문에 별도의 레이아웃 */,
      children: [
        {
          path: "",
          name: "pubOrderNpay",
        ...
        },
        {
          ...
          component: () =>
            import("@/views/publishing/orderNpay/OrderNpayDetail.vue"),
          meta: {
            title: "리포트 주문상세",
          },
        },
      ...
      children: [
        {
          ...
          component: () =>
            import("@/views/publishing/checkup/CheckupDateSelect.vue"),
          meta: {
            title: "검진일 선택",
            class: "middle",
          },
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () =>
            import("@/views/publishing/analyze/AnalyzeDetail.vue"),
          meta: {
            title: "마이웰니스 랩 분석 결과",
            class:
              "whiteHeader wide" /* 231201 이 페이지만 헤더 색이 달라서 클래스 추가 */,
          },
        },
        {
        ...
        },
        {
          ...
          component: () =>
            import("@/views/publishing/analyze/AnalyzeHealthLightDetail.vue"),
          meta: {
            title: "건강 신호등",
            class: "wide",
          },
        ...
        // },
        {
          ...
          component: () =>
            import("@/views/publishing/analyze/AnalyzeABCHealthGradeDetail.vue"),
          meta: {
            title: "ABC 건강 등급",
            class: "wide",
          },
    ...
    },
    {
      ...
      children: [
        ...
        {
          /* 231212 퍼블용 */ path: "pub-my-page-checkup-data-record-detail",
        ...
        {
          /* 231212 퍼블용 */ path: "pub-my-page-report-print-record",
          name: "pubMyPageReportPrintRecord",
          component: () =>
            import("@/views/publishing/mypage/MyPageReportPrintRecord.vue"),
          meta: {
            title: "리포트 인쇄신청 이력",
            class: "middle",
          },
