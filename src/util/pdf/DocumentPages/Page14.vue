<template>
  <div id="page" class="custom-page a4" :class="save ? 'stretch-page' : ''">
    <div class="page-inside">
      ...
      <div class="title-container">
        <div class="title">
          ...
          <span class="stretch-text">
            만성질환 억제 분석 지수는 나의 신진대사 능력을 100점 척도로 평가한
            점수입니다. 나의 점수를 확인해 보세요.
          </span>
        </div>
        <div class="vertical-line"></div>
        <div class="score-container">
          <div class="bold stretch-text">[나의 만성질환 억제 분석 지수]</div>
      ...
      <div class="data-container">
        <div class="subject">
          <h3 class="stretch-text">
            [한국인 {{ userInfo.sex === 1 ? "남성" : "여성" }} 연령별 만성질환
            억제 분석 지수 분포와 나의 위치]
          </h3>
          <div class="legend">
            <div class="avg"></div>
      ...
      <div class="desc">
        <span class="stretch-text">
          {{ userInfo.name }}님의 만성질환 억제 분석 지수는 {{ value.Met
          }}{{ "점이며," }} 한국 성인 평균 72점과 비교하여 건강상태가
          {{ value.Met <= 72 ? "나쁨" : value.Met > 72 ? "좋음" : "보통" }}으로
          판정됩니다. 이 수치는 {{ userInfo.name }}님의 연령대
          {{ parseInt(userInfo.age / 10) * 10 }}대
          {{ userInfo.sex === 1 ? "남성" : "여성" }} 100명 중에서
          {{ myPercent.MetPerc }}등에 해당하여 평균 점수인
          {{ health.resultDto.myHQ.MET_MEAN.toFixed(1) }}점과 비교하여
          {{
            value.Met > health.resultDto.myHQ.MET_MEAN
              ? "높은 수준입니다. 건강을 위해 신체의 대사능력을 유지시킬 필요가 있습니다."
              : value.Met < health.resultDto.myHQ.MET_MEAN
              ? "낮은 수준입니다. 건강을 위해 신체의 대사능력을 향상시킬 필요가 있습니다."
              : "비슷한 수준입니다. 건강을 위해 신체의 대사능력을 향상시킬 필요가 있습니다."
          }}
        </span>
      </div>
      <hr />
      <div class="bottom-info">
        *본 서비스는 질병의 예방 또는 진단을 목적으로 제공되는 서비스가
        ...
        상의하시기 바랍니다. 만성질환 억제 분석 지수는 건강 검진 결과, 생활 습관
        등 다양한 요소 간의 상관관계를 종합적으로 고려하여 산출됩니다. 따라서,
