...
class Food {
  constructor() {  
    this.food_id =0;  // INGREDIENT ID
    this.food_name='';  // INGREDIENT 명칭
  ...
  setData(item, input_status) {
    ...
    this.food_id =  item.food_id != undefined && item.food_id != '' ?  item.food_id : 0;
    this.food_name = item.food_name != undefined && item.food_name != '' ?  item.food_name : '';
    ...
    this.url = item.url != undefined && item.url != '' ?  item.url : '';
    this.image_path = item.image_path != undefined && item.image_path != '' ?  item.image_path : '';
