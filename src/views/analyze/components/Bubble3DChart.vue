...
const resizeChart = () => {
  Plotly.Plots.resize(document.querySelector('#Bubble3DChart .Bubble3DChart-container'));
...
const drawChart = (x, y, z) => {
  ...
  Plotly.newPlot(scatter3d.value, data, layout, { 
  ...
  const plotlyContainer = scatter3d.value.querySelector('.plotly');
  if (plotlyContainer) {
...
const rotateVertical = (id, angle) => {
  ...
  Plotly.relayout(scatter3d.value, id + '.camera.eye', newEye)
}
...
<template>
  <div id="Bubble3DChart">
    <div class="Bubble3DChart-container" ref="target">
...
<style>
#Bubble3DChart .Bubble3DChart-container {
    position: relative;
    margin: 0px auto 1.875rem;
    width: 100%;
}

#Bubble3DChart .btn-reload {
  position: absolute;
  top: 0;
  right: 0;
  cursor: pointer;
...
#Bubble3DChart .arrow-container .arrow-left {
  left: -4%;
  top: 50%;
  position: absolute;
...
#Bubble3DChart .arrow-container .arrow-right {
  right: -4%;
  top: 50%;
  position: absolute;
  display: inline-block;
...
/* 위쪽 화살표 */
#Bubble3DChart .arrow-container .arrow-up {
...
/* 아래쪽 화살표 */
#Bubble3DChart .arrow-container .arrow-down {
  bottom: -178px;
  left: 50%;
  position: absolute;
  display: inline-block;
...
/* Plotly 호버 효과 완전 차단 */
#Bubble3DChart .chart .plotly .hoverlayer {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
}

#Bubble3DChart .chart .plotly .hovertext {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
}

#Bubble3DChart .chart .plotly .spikeline {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
}

#Bubble3DChart .chart .plotly .spikeline-3d {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
}
...
/* 3D 격자 호버 효과 차단 */
#Bubble3DChart .chart .plotly .scene .grid {
    pointer-events: none !important;
}

#Bubble3DChart .chart .plotly .scene .axis {
    pointer-events: none !important;
}
...
#Bubble3DChart .chart .plotly .spikeline,
#Bubble3DChart .chart .plotly .spikeline-3d,
#Bubble3DChart .chart .plotly .spikeline-x,
#Bubble3DChart .chart .plotly .spikeline-y,
#Bubble3DChart .chart .plotly .spikeline-z,
#Bubble3DChart .chart .plotly .spikeline-xy,
#Bubble3DChart .chart .plotly .spikeline-xz,
#Bubble3DChart .chart .plotly .spikeline-yz {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
    pointer-events: none !important;
...
/* 3D 격자 호버 시 진한 선 차단 */
#Bubble3DChart .chart .plotly .scene .grid line {
    pointer-events: none !important;
}

#Bubble3DChart .chart .plotly .scene .axis line {
    pointer-events: none !important;
}
</style>