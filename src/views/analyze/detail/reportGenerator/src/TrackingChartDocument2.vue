  ...
  <div class="chart-wrap">
    ...
    <div class="graph">
      <div class="my-point-pointer">
        <div class="pointer" :style="{ left: getMean() }" />
...
export default {
  ...
  methods: {
     ...
     */
    isnormal_range () {
      const myDataValue = this.comph.resultDto.myData[this.var] // this.comph.resultDto.myData;
    ...
    calculateNormal (value) {
      ...
      switch (this.imgName) {
        case 'half':
          ...
          if (this.comData.normal_range_max >= this.comData.range_max) { this.comData.normal_range_max = this.comData.range_max }
          rate =
            100 / 2 +
    ...
    initChart () {
      ...
      const varName = getVarName(this.var)
