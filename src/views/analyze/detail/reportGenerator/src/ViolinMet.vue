  ...
  <div class="chart-wrapper">
    <div class="data-container">
      <div class="subject">
        <h3>
          <!-- 분포와 나의 등수] -->
          [{{ $t('ViolinMet.text3') }} {{ userInfo.sex === 1 ? "남성" : "여성" }} {{ $t('ViolinMet.text4') }}]
        </h3>
        <div class="legend">
          <div class="avg" />
          <div class="t">{{ $t('ViolinMet.text5') }}</div>
          <div class="legend-icon" />
          <div class="t">{{ userInfo.name }}{{ $t('Common.name') }}</div>
        </div>
      </div>
      <!-- 그래프 배경 -->
      <div class="violin-container">
        <div class="violin">
          <div class="axis-y">
            <div class="label-y">{{ $t('ViolinMet.text7') }}<br />{{ $t('ViolinMet.text8') }}</div>
            <div>100</div>
            <div>80</div>
            <div>60</div>
            <div>40</div>
          ...
          <div class="table">
            ...
            <div
              ...
              <div class="my-point-score">{{ myPercent.MetPerc }}{{ $t('Common.rank') }}</div>
            </div>
          </div>
        </div>
        <img
        ...
        <img
          ...
          v-if="userInfo.sex === 2" />
        <div class="axis-x">
          <div class="label-x">{{ $t('ViolinMet.text10') }}</div>
...
.data-container {
  ...
  .subject {
    ...
    width: calc(520px * $pdf-scale);

    /* padding-top: calc(12.39px * $pdf-scale); */
    padding-left: calc(0px * $pdf-scale);
