...
const description = computed(() => {
  return props.health.resultDto.myHQ.OXI_MSG.replaceAll('@@@', props.userInfo.name)
})
</script>
    ...
    <div class="page-inside">
      ...
      <div class="title-container">
        <div class="title">
          ...
          <h3 class="stretch-text">{{ $t('Page13.text1') }}</h3>
        ...
        <div class="score-container">
          <div class="stretch-text">[{{ $t('Page13.text3') }}]</div>
      ...
      <div class="data-container">
        <div class="subject">
          ...
          <div class="legend">
            <div class="avg" />
            <div class="stretch-text">{{ $t('Page13.text4') }}</div>
        ...
        <div class="violin-container">
          <div class="violin">
            <div class="axis-y">
              <div class="label-y stretch-text">{{ $t('Page13.text1') }}</div>
            ...
            <div class="table">
              ...
              <div
                ...
                <div class="my-point-score stretch-text">
                  {{ myPercent.OxiPerc }}{{ $t('Common.rank') }}
                </div>
              </div>
            </div>
          </div>
