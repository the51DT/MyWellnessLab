...
// 해당 페이지 표현해야할 항목, 텍스트
import { rst1 } from '@/assets/js/chart/documentText'
    ...
    <div class="page-inside">
      ...
      <div class="title-container">
        <div class="title">
          ...
          <h3 class="stretch-text">{{ $t('Page18.text1') }}</h3>
        </div>
      ...
      <div class="legend-container">
        ...
        <span class="stretch-text">{{ $t('Page18.text3') }}</span>
        <div class="legend2">
          <img src="/img/pdf/res/ico_manage.svg" alt="" />
        </div>
        <span class="stretch-text">{{ $t('Page18.text4') }}</span>
      </div>
...
.data-container {
  width: 100%;
  height: calc(616.24px * $pdf-scale);
