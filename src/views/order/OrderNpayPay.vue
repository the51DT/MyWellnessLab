...
import BaseTooltip from "@/views/orderNpay/BaseTooltipOrderNpay.vue";
import OrderNpayCashReceipt from "@/views/orderNpay/OrderNpayCashReceipt.vue";
import OrderNpayApply from "@/views/orderNpay/OrderNpayApply.vue";
...
<template>
  <section class="pay-method"> <!--결제수단-->
    ...
    <div v-show="togglePayMethod"> <!--결제수단 내용 들-->
      ...
      <div class="pay-method--pay simple-pay" :class="props.payMethod === 'basicAuto' ? 'disSelect' : props.payMethod === 'basicCard' ? 'disSelect' : ''"> <!--심플페이-->
...
<!--        </div>-->
        ...
        <div class="tooltip pay-method--user-select"> <!--툴팁의 위치를 잡기위해 한번 더 싸줌-->
          ...
          <button @click="tooltipPayUserSelect = !tooltipPayUserSelect" class="btn--tooltip" type="button" title="도움말"></button>
        ...
        <div class="space--top-default"> <!--a pay 선택-->
          ...
          <div class="align--horiz full">
            <button @click="payMethod('apayAuto')" type="button" class="btn--big" :class="props.payMethod === 'apayAuto' ? 'active' : ''">A Pay 자동이체</button>
            <button @click="payMethod('apayCard')" type="button" class="btn--big" :class="props.payMethod === 'apayCard' ? 'active' : ''">A Pay 카드 결제</button>
          </div>
      ...
      <div class="pay-method--pay normal" :class="props.payMethod === 'basicAuto' ? 'select' : props.payMethod === 'basicCard' ? 'select' : ''"> <!--다른 결제수단 (자동이체, 신용카드)-->
        ...
        <div v-show="props.payMethod === 'basicAuto' || props.payMethod === 'basicCard'" class="pay-method--other-method">
          <div class="align--horiz full">
            <button @click="payMethod('basicAuto')" class="btn--big" :class="props.payMethod === 'basicAuto' ? 'active' : ''" type="button">자동이체</button>
            <button @click="payMethod('basicCard')" class="btn--big" :class="props.payMethod === 'basicCard' ? 'active' : ''" type="button">신용카드</button>
          </div>
