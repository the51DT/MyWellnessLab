...
<template>
  ...
  <BasePopupBadge v-if="badgePopup" @popupClose="badgePopupClose = true" type="pin" frontImg="/img/badgeImg/pin--ruby.svg">$마웰랩 핀 명칭$</BasePopupBadge> <!-- 260911 핀 컨펌 버전으로 수정 -->
