...
<template>
  ...
  <BasePopupBadge v-if="badgePopup" @popupClose="badgePopupClose = true" type="pin" frontImg="/img/badgeImg/pin--ruby.png">$마웰랩 핀 명칭$</BasePopupBadge> <!-- 260911 핀 컨펌 버전으로 수정 --> <!-- 260923 핀 png로 변경 -->
  <!--<BasePopupBadge v-if="badgePopup" @popupClose="badgePopupClose = true" type="badge" frontImg="/img/badgeImg/badge--happy_birthday.svg">$배지 명칭$</BasePopupBadge>--> <!-- 260904 배지 컨펌 버전으로 수정 -->
