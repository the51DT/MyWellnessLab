...
export default {
  name: 'AnalyzeAgingInhibitionAnalyzeIndexDetailPopup',
  setup () {
    ...
    <div class="popup--wrap tit AnalyzeAgingInhibitionAnalyzeIndexDetailPopup--popup-wrap">
      <div class="align--between popup--header AnalyzeAgingInhibitionAnalyzeIndexDetailPopup--header">
        ...
        <div class="popup--tit-wrap AnalyzeAgingInhibitionAnalyzeIndexDetailPopup--tit-wrap">
          <span class="popup--tit AnalyzeAgingInhibitionAnalyzeIndexDetailPopup--tit">나의 변화</span>
        </div>
        <div class="AnalyzeAgingInhibitionAnalyzeIndexDetailPopup--close"> <!--231212 클래스 삭제-->
          <button @click="close" type="button" class="popup--close AnalyzeAgingInhibitionAnalyzeIndexDetailPopup--close-btn" /> <!--231212 x 삭제-->
        </div>
      </div>
      <div class="popup--space AnalyzeAgingInhibitionAnalyzeIndexDetailPopup--space">
        <!--        <canvas id="chartDom" class="AnalyzeAgingInhibitionAnalyzeIndexDetailPopup&#45;&#45;chart"></canvas> &lt;!&ndash;그래프&ndash;&gt;-->
