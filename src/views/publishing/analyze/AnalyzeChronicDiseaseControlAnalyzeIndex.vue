...
export default {
  ...
  methods: {
    ...
    go () { /* 자세히 보기 이동 */
      router.push('/publishing/analyze/analyze-chronic-disease-control-analyze-index-detail')
    }
  },
  mounted () {
...
<template>
  <div class="AnalyzeChronicDiseaseControlAnalyzeIndex"> <!--노화 억제 분석 지수-->
    <div class="tooltip AnalyzeChronicDiseaseControlAnalyzeIndex--tooltip">
      <h2 class="tooltip--tit AnalyzeChronicDiseaseControlAnalyzeIndex--tip-tit">만성질환 억제 분석 지수</h2>
      <button
      ...
      <base-tooltip
        ...
        <template v-slot:contents>
          <p class="AnalyzeChronicDiseaseControlAnalyzeIndex--tip-txt">만성질환 억제 분석 지수는 나의 신진대사 능력을 100점 척도로 평가한 점수입니다 나의
            점수를 확인해 보세요</p>
        </template>
      </base-tooltip>
    ...
    <div class="analyze-box">
      <p class="AnalyzeAgingInhibitionAnalyzeIndex--info">만성질환 억제 분석지수는
