...
const handleSecondCertification = async () => {
  const nhisData = convertAnalysisData({
    resCheckupYear: '2026',
    resCheckupDate: '1025',
    resHeight: 175,
    resWeight: 78,
    resWaist: 88,
    resBMI: 25.5,
    resBloodPressure: '132/86',
    resFastingBloodSuger: 104,
    resTotalCholesterol: 205,
    resLDLCholesterol: 135,
    resHDLCholesterol: 46,
    resTriglyceride: 165,
    resAST: 32,
    resALT: 41,
    resSerumCreatinine: 1.0,
    resHemoglobin: 15.1
  })
